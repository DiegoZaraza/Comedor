...
public class ComedorGUI extends JFrame {
	...
	public void updateNroAlumnos(String n){
		nAlumnos.setText("<html><body><center>Nro. de Alumnos: <font color='blue'><b>"+n+"</b> " +
...
//		jMenuItemList
	...
	public ComedorGUI() {
		...
		KeyStroke ctrlP11 = KeyStroke.getKeyStroke(KeyEvent.VK_P,
		...
		System.out.println("))"+"044890494Z".length());
...
//		menu3.setFont(new Font("tahoma",Font.BOLD,12));
		...
		itemExFotos.addActionListener(new ActionListener() {
...
//		itemFotos.setForeground(Color.RED);
//		itemExFotos.setForeground(Color.RED);
		KeyStroke ctrlP111 = KeyStroke.getKeyStroke(KeyEvent.VK_I,
				InputEvent.CTRL_MASK);
		itemFotos.setAccelerator(ctrlP111);
		
		KeyStroke ctrlP1111 = KeyStroke.getKeyStroke(KeyEvent.VK_E,
				InputEvent.CTRL_MASK);
...
//		menu.getComponentPopupMenu().setBackground(Color.lightGray);

		menu.add(itemExFotos);
//		itemFotos.setFont(new Font("tahoma",Font.BOLD,12));
		menu.add(new JSeparator());
...
//					n.setForeground(Color.WHITE);
				...
				{
				{
					...
					fieldCode.addKeyListener(new KeyListener() {
...
//												if(b){
//													fieldCode.setText("");
//														RegistrarAlumno a=new RegistrarAlumno(getInstance(),g,true);
//													desktop.add(a);
//													a.setEnabledNIA(false);
//													a.loadDatos();
//													n=true;
...
//											n=true;
		...
		checkCamara();
		fieldCode.addMouseListener(new MouseListener() {
...
//		jcMousePanel1111.add(comboBox);
		...
		tableBusqueda.addMouseListener(new MouseListener() {
...
//					if(a==null)
//						   a=new RegistrarAlumno(getInstance(),tableBusqueda.getValueAt(tableBusqueda.getSelectedRow(), 1).toString(),true);
//						else 
//							return;
//						desktop.add(a);
//						boolean z=false;
//						if(dia.equalsIgnoreCase("lunes") || dia.equalsIgnoreCase("martes")){
//							z=getBaseDeDatos().verificarSiEstaAutorizadoLunesMartes(tableBusqueda.getValueAt(tableBusqueda.getSelectedRow(), 1).toString());
//						}else
//						if(dia.equalsIgnoreCase("jueves")){
//							z=getBaseDeDatos().verificarSiEstaAutorizadoJueves(tableBusqueda.getValueAt(tableBusqueda.getSelectedRow(), 1).toString());
//						}
//						if(!z){
//							JOptionPane.showMessageDialog(getInstance(), "No Autorizado!","Denegado",JOptionPane.WARNING_MESSAGE);	
//							a=null;
...
//		labelDenominacion.setVisible(off);
	}
