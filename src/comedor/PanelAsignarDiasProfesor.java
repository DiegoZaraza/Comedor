		...
		gl_panel_3.setHorizontalGroup(
			gl_panel_3.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_3.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblEstadoDeRemesa)
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(lblApellidosYNombre, GroupLayout.PREFERRED_SIZE, 110, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(panel_6, GroupLayout.PREFERRED_SIZE, 192, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								...
								.addComponent(labelNombre))
							.addGap(57)
							.addComponent(panel_5, GroupLayout.PREFERRED_SIZE, 65, GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
							.addComponent(panel, GroupLayout.PREFERRED_SIZE, 194, GroupLayout.PREFERRED_SIZE)
							.addGroup(groupLayout.createSequentialGroup()
								.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
									.addComponent(lblDocumento, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE)
									.addComponent(labelDocumento)
								...
								.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
									...
									.addGroup(groupLayout.createSequentialGroup()
										...
										.addComponent(panel_4, GroupLayout.PREFERRED_SIZE, 168, GroupLayout.PREFERRED_SIZE))))))
					.addContainerGap())
		);
...
//					String mes=comboBox_1.getSelectedItem().toString().split("-")[0];
					
//					float saldoAUsar=0;
//					if(chckbxUsarSaldo.isSelected()){
//						saldoAUsar=Float.parseFloat(textField_1.getText());	
//					}
//					String estado=""+lblPagado.getText();
//					if(estado.indexOf("PAGADO")!=-1){
//						estado="PAGADO";
//					}else if(estado.indexOf("INCOMPLETO")!=-1){
//						estado="INCOMPLETO";
//					}else{
//						estado="PENDIENTE";
//					}
//					if(estado.equalsIgnoreCase("PAGADO")){
//						principal.getBaseDeDatos().bloquearDeudasAnteriores(documento);
//					}
...
//					principal.getBaseDeDatos().addRemesaProfesor(documento,mes,total,deudaTotal,extra,pagado,estado,saldoAUsar,pagadoTotal);
//					DecimalFormat df = new DecimalFormat("###.##");
//					label_5.setText(""+df.format(principal.getBaseDeDatos().getAbono(documento))+"€");
//					textField.setText("");
//					textField_1.setText("");
//					label_7.setText("0");
//					label_3.setText("0");
...
//					deudaTotal=0;
//					extra=0;
////					lblPagado.setText("<HTML><BODY><font color='ORANGE'><b>PENDIENTE<b></FONT></BODY></HTML>");
//					pagado=0;
//					saltoAFavor=0;
//					saltoAFavor=principal.getBaseDeDatos().getAbono(documento);
//					label_5.setText(""+df.format(principal.getBaseDeDatos().getAbono(documento))+"€");
//					deudaAnteriores=principal.getBaseDeDatos().getDeudaGeneral(documento);
////					System.out.println(deudaAnteriores);
////					deudaAnteriores= deudaAnterior
//					if(saltoAFavor>=deudaAnteriores){
//						saltoAFavor=saltoAFavor-deudaAnteriores;
////						saltoAFavor=principal.getBaseDeDatos().getAbono(documento);
//						label_5.setText(""+df.format(saltoAFavor)+"€");
//					}
//					DecimalFormat dfx1 = new DecimalFormat("###.##");
//					label_6 .setText(""+dfx1.format(deudaAnteriores)+"€");
...
//			saltoAFavor=saltoAFavor-deudaAnteriores;
////			saltoAFavor=principal.getBaseDeDatos().getAbono(documento);
//			label_5.setText(""+df1.format(saltoAFavor)+"€");
//		}
				
//				saltoAFavor=principal.getBaseDeDatos().getAbono(documento);
//		label_5 = new JLabel(""+df1.format(principal.getBaseDeDatos().getAbono(documento))+"€");
//		
//		DecimalFormat dfx1 = new DecimalFormat("###.##");
		...
		gl_panel_5.setHorizontalGroup(
			gl_panel_5.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_5.createSequentialGroup()
					.addContainerGap()
					.addComponent(btnNewButton_2, GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
					.addGap(343))
		);
...
//		tableRemesas.getColumn("Recibo").setPreferredWidth(27);
//		tableRemesas.getColumn("Recibo").setPreferredWidth(27);
//		
//		tableRemesas.getColumn("Precio de Recibo").setPreferredWidth(87);
//		tableRemesas.getColumn("Precio de Recibo").setPreferredWidth(87);
//		
//		tableRemesas.getColumn("Mes").setPreferredWidth(27);
//		tableRemesas.getColumn("Mes").setPreferredWidth(27);
//		tableRemesas.getColumn("Pagado").setPreferredWidth(47);
//		tableRemesas.getColumn("Pagado").setPreferredWidth(47);
//		
//		tableRemesas.getColumn("Saldo Usado").setPreferredWidth(60);
//		tableRemesas.getColumn("Saldo Usado").setPreferredWidth(60);
		...
		gl_panel_2.setHorizontalGroup(
			gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblSeleccionDeDia)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(textFieldDia, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
				...
				.addGroup(gl_panel_1.createSequentialGroup()
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(comboBox_2, 0, 133, Short.MAX_VALUE))
						.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 169, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panel_1.createSequentialGroup()
							.addComponent(lblOedinarios)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(label_8))
						.addGroup(gl_panel_1.createSequentialGroup()
							.addComponent(lblExtraordinarios)
							.addPreferredGap(ComponentPlacement.RELATED)
