...
//				// TODO Auto-generated method stub
//				
//				boolean b =principal.getBaseDeDatos().verificarSiExiste(textField_2.getText());
//				if(b) {
//					lblNewLabel_7.setVisible(true);
//					lblNewLabel_7.setBusy(true);
//					int y=JOptionPane.showConfirmDialog(principal, "<html><body>Alumno ya registrado<br>Desea cargar sus Datos?</body></html>","Existente",JOptionPane.INFORMATION_MESSAGE);
...
//		});
		...
		comboBox.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
//				if(comboBoxTutor!=null){
//				try{
//					if(comboBoxTutor!=null){
//						arrayListTutor.clear();
//						comboBoxTutor.removeAllItems();
//						String codigo=arrayListgrupos.get(comboBox.getSelectedIndex());
////						System.out.println("CODIGO GRUPO > "+codigo);
//						principal.getBaseDeDatos().getTutores(comboBoxTutor,arrayListTutor);
//						
//						setTutor(principal.getBaseDeDatos().getTutorDeGrupo(codigo));
//					}
//				}catch(Exception e){
//					e.printStackTrace();
//					arrayListTutor.clear();
...
////				}
		...
		btnAgregarFamiliar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Object s = JOptionPane.showInputDialog(getInstance(), "Seleccionar",
						"Seleccionar", JOptionPane.QUESTION_MESSAGE,
				null, bigList, "Titan");
				if(s!=null){
					String parentesco="";
...
//			new DialogoFechaAltaBaja(principal,getNia()).setVisible(true);	
			principal.getBaseDeDatos().getFechasPeriodo(getNia(),tableFechas,listFechas);
			}
		});
		panel_5.add(btnNewButton_4);
		//		JComboBox<Object> x =new JComboBox<>();
...
//							new DialogoFechaAltaBaja(principal, getNia(), id).setVisible(true);
							principal.getBaseDeDatos().getFechasPeriodo(getNia(),tableFechas,listFechas);
						}else{
...
//					jkTable.getTableHeader().setResizingAllow
					principal.getBaseDeDatos().getFaltasPorAlumno(getNia(),jkTable,arrayList);
...
//							principal.getBaseDeDatos().actualizarFamiliars(getNombrePadre(),getApellidoPadre(),getTelefonoPadre(),getDireccionPadre(),getNombreMadre(),getApellidoMadre(),getTelefonoMadre(),getDireccionMadre(),getNia(),idPadre,idMadre);
							
							
//							principal.getBaseDeDatos().actualizarStatusAlumno(getNia(),getPersonaDeContacto(),getUsuarioComedor(),getTipoUsuario(),getInformedico(),getMedicamentos(),getBeca(),getCuentaBancaria());
							
//							principal.getBaseDeDatos().actualizarStatusAlumno(getNia(),getPersonaDeContacto(),getUsuarioComedor(),getTipoUsuario(),getInformedico(),getMedicamentos(),getfechaAlta(),getfechaBaja(),getBeca());
...
//						principal.getBaseDeDatos().newFamiliars(getNombrePadre(),getApellidoPadre(),getTelefonoPadre(),getDireccionPadre(),getNombreMadre(),getApellidoMadre(),getTelefonoMadre(),getDireccionMadre(),nia);
//						principal.getBaseDeDatos().newStatusAlumno(nia,getPersonaDeContacto(),getUsuarioComedor(),getTipoUsuario(),getInformedico(),getMedicamentos(),getBeca(),getCuentaBancaria());
	...
	public synchronized void addFamiliar(String parentesco,String nombre,String apellido1,String apellido2,String documento,String tipo_doc,String alumno,String id,String es){
		...
		if(parentesco.equalsIgnoreCase("1")){
			tipo="Madre";
...
//		
//	}
//	public void setNombrePadre (String n){
...
//		
//	}
//	public void setNombreMadre(String n){
...
//		
//	}
//	public void setApellidoPadre (String n){
...
//		
//	}
//	public void setApellidoMadre(String n){
...
//		
//	}
//	public void setTelefonoMadre (String n){
...
//		
//	}
//	public void setTelefonoPadre(String n){
...
//		
//	}
//	public void setDireccionPadre(String n){
//		textArea.setText(n);
//	}
...
//		
//	}
//	public void setDireccionMadre(String n){
...
//	}
	...
	//textField_9=persona de contacto
	//
	//usuario comedor
	//chckbxNewCheckBox
	//chckbxNo
	...
	//chckbxDias
	//
	//textArea_2=informe medico
	//textField_10 = medicamentos
	//
	//textField_11 = fecha alta
	//textField_12=fecha baja
...
//		try {
//			new Date(textField_11.getDateEditor().getDate().getTime());
//		} catch (Exception c) {
//			return new Date(new java.util.Date().getTime());
//		}
//		return new Date(textField_11.getDateEditor().getDate().getTime());
//	}
...
//			dateFormat=new SimpleDateFormat("dd/MM/yyy");
//		try {
//			textField_11.setDate(dateFormat.parse(fechaAlta));
//
//		} catch (ParseException e) {
//			e.printStackTrace();
//		}
...
//		try {
//			new Date(textField_12.getDateEditor().getDate().getTime()).toString();
//		} catch (Exception c) {
//			return new Date(new java.util.Date().getTime());
//		}
//		return new Date(textField_12.getDateEditor().getDate().getTime());	
//	}
//	public void setFechBaja(String fechaAlta){
//		SimpleDateFormat dateFormat = new SimpleDateFormat("yyy-MM-dd");
//		try {
//			textField_12.setDate(dateFormat.parse(fechaAlta));
//
//		} catch (ParseException e) {
//			e.printStackTrace();
//		}
