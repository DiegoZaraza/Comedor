...
public class PDF_Carta_3 {
	...
	public PDF_Carta_3(ComedorGUI principal,String nia) throws DocumentException, MalformedURLException, IOException {
		...
		// TODO Auto-generated method stub
				...
				Paragraph texto22 = new Paragraph("NOTIFICACIÓ DE BAIXA DE MENJADOR", FontFactory.getFont("arial",12,
...
//				document.add(texto22);
				...
				new DecimalFormat("###.##");
				texto22 = new Paragraph("La Secretària de l'IES El Saler li informa que, després d'haver estat informat en diverses ocasions, encara manté un deute amb el centre de quotes de menjador, i per tant la Direcció ha decidit donar de baixa els seus fills/filles del servei de menjador a partir del dia ______________________.", FontFactory.getFont("arial",10,
						Font.NORMAL, BaseColor.BLACK));
				texto22.setAlignment(Chunk.ALIGN_JUSTIFIED);
				document.add(new Paragraph("\n\n"));
				document.add(texto22);
				texto22 = new Paragraph("Li recordem així mateix, que l'assistència al menjador escolar no és obligatòria i que l'ús d'este servei comporta unes obligacions, entre les quals figura el pagament de les quotes en els terminis establerts en el Reglament de Règim Interior, i que en el cas dels seus fills/filles ja han passat.", FontFactory.getFont("arial",10,
						Font.NORMAL, BaseColor.BLACK));
				texto22.setAlignment(Chunk.ALIGN_JUSTIFIED);
				document.add(new Paragraph("\n\n"));
				document.add(texto22);
				...
				texto22 = new Paragraph("Li preguem que es pose en contacte amb la Direcció per resoldre aquesta situació el més aviat possible.", FontFactory.getFont("arial",10,
						Font.NORMAL, BaseColor.BLACK));
				texto22.setAlignment(Chunk.ALIGN_JUSTIFIED);
				document.add(new Paragraph("\n\n"));
				document.add(texto22);
				
				texto22 = new Paragraph("I li recordem una volta més que ha de fer l'ingrés directament al compte de Bankia de l'IES El Saler :", FontFactory.getFont("arial",10,
						Font.NORMAL, BaseColor.BLACK));
				texto22.setAlignment(Chunk.ALIGN_LEFT);
//				document.add(new Paragraph("\n\n"));
				document.add(texto22);
