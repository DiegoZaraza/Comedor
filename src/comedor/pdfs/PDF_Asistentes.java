...
public class PDF_Asistentes {
	...
	public PDF_Asistentes(ArrayList<Persona> arrayList, java.util.Date date,
			java.util.Date date2,ComedorGUI principal) throws FileNotFoundException, DocumentException {
		// TODO Auto-generated constructor stub
		// TODO Auto-generated method stub
				document = new Document();
				PdfWriter.getInstance(document,
						new FileOutputStream("System-Comedor"+File.separator+"Temp"+File.separator+"listado_asistentes.pdf"));
				document.open();
				Paragraph texto22 = new Paragraph("LISTADO DE ASISTENTES AL COMEDOR", FontFactory.getFont("arial",12,
				...
				celda.setBackgroundColor(new BaseColor(new Color(230, 223, 223)));
				tabla.addCell(celda);
				celda = new PdfPCell(new Paragraph("ASISTENCIAS", FontFactory.getFont("arial", // fuente
						6, // tamaño
						Font.NORMAL, // estilo
						BaseColor.BLACK))); // color
				celda.setColspan(1);// abarca 1 fila
				...
				if(principal.getBaseDeDatos().getImpresionDirecta()){
					...
					try {
						Desktop.getDesktop().open(
								new File("System-Comedor"+File.separator+"Temp"+File.separator+"listado_asistentes.pdf"));
					} catch (IOException e) {
