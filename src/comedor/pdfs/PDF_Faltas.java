...
public class PDF_Faltas
{
	...
	public PDF_Faltas(ArrayList<Persona> arrayList, java.util.Date date, java.util.Date date2, ComedorGUI principal) throws FileNotFoundException, DocumentException
	{
		...
		celda = new PdfPCell(new Paragraph("NUMERO DE AUSENCIAS", FontFactory.getFont("arial", 6, Font.NORMAL, BaseColor.BLACK)));
		celda.setColspan(1);// abarca 1 fila
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		...
		PdfPCell uc1 = new PdfPCell(new Paragraph("Ausencias Totales: " + count,
				FontFactory.getFont("arial", // fuente
						8, // tamaño
						Font.BOLD, // estilo
