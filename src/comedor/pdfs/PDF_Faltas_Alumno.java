...
public class PDF_Faltas_Alumno {

	private static Document document;
	private static PdfPCell celda;
	private static Paragraph t2;

	public PDF_Faltas_Alumno(ArrayList<String> arrayList, java.util.Date date,
		...
		// TODO Auto-generated method stub
				...
				String pp=arrayList.get(index);
					t2 = new Paragraph(""+pp.split("@1")[0]+"/"+pp.split("@1")[1], FontFactory.getFont("arial", // fuente
							11, // tamaño
							Font.NORMAL, // estilo
							BaseColor.BLACK));
					tabla.addCell(t2);
					t2 = new Paragraph(pp.split("@1")[2], FontFactory.getFont("arial", // fuente
							11, // tamaño
							Font.NORMAL, // estilo
							BaseColor.BLACK));
					tabla.addCell(t2);
