...
public class PDF_Listado_RangoDias {
	...
	public PDF_Listado_RangoDias(Date fecha1,Date fecha2, ComedorGUI principal,ArrayList<String> arrayList,Hashtable<String, Integer> hashtable, String modo) throws FileNotFoundException, DocumentException, ParseException {
		// TODO Auto-generated constructor stub
		// TODO Auto-generated method stub
				document = new Document();
				PdfWriter.getInstance(document,
						new FileOutputStream("System-Comedor"+File.separator+"Temp"+File.separator+"listado_dias.pdf"));
				document.open();
				{
				Paragraph texto22 = new Paragraph("LISTADO POR RANGO DE FECHAS", FontFactory.getFont("arial",12,
				...
				{
					Paragraph texto22 = new Paragraph("Desde: "+principal.getBaseDeDatos().getFechaHumana(fecha1), FontFactory.getFont("arial",12,
							Font.NORMAL, BaseColor.BLACK));
					texto22.setAlignment(Chunk.ALIGN_CENTER);
					document.add(texto22);
				}{
					Paragraph texto22 = new Paragraph("Hasta: "+principal.getBaseDeDatos().getFechaHumana(fecha2), FontFactory.getFont("arial",12,
							Font.NORMAL, BaseColor.BLACK));
					texto22.setAlignment(Chunk.ALIGN_CENTER);
					document.add(texto22);
				}
				{
					if(modo.equalsIgnoreCase("Ambos")){
						{
							Paragraph texto22 = new Paragraph("Dias: Ordinarios/Extraordinarios", FontFactory.getFont("arial",12,
									Font.BOLD, BaseColor.BLACK));
							texto22.setAlignment(Chunk.ALIGN_CENTER);
							document.add(texto22);
						}	
					}else{
					Paragraph texto22 = new Paragraph("Dias: "+modo, FontFactory.getFont("arial",12,
							Font.BOLD, BaseColor.BLACK));
					texto22.setAlignment(Chunk.ALIGN_CENTER);
					document.add(texto22);
					}
				...
				if(principal.getBaseDeDatos().getImpresionDirecta()){
					...
					try {
						Desktop.getDesktop().open(
								new File("System-Comedor"+File.separator+"Temp"+File.separator+"listado_dias.pdf"));
					} catch (IOException e) {
