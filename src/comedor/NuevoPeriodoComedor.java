	...
	public NuevoPeriodoComedor(ComedorGUI comedorGUI, final String nia, final boolean actualizar, final String id) 
	{
		...
		btnNewButton.addActionListener(
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				int v = JOptionPane.showConfirmDialog(principal, "Esta seguro(a) de Agregar este Periodo?", "Conformacion", JOptionPane.INFORMATION_MESSAGE);
				...
				if(v== JOptionPane.OK_OPTION)
				{
					...
					boolean n = principal.getBaseDeDatos().addFechas(getfechaAlta(), getfechaBaja(), nia, getTipoBeca(), getTipoUsuario(), isAsiduo(), lunesMartes, jueves, isSalida());
		...
		btnActualizar.addActionListener(
			...
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				int v = JOptionPane.showConfirmDialog(principal, "Esta seguro(a) de Aplicar la Actualizacion este Periodo?", "Confirmacion", JOptionPane.INFORMATION_MESSAGE);
