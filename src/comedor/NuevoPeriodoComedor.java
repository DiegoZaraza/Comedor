...
//			textFieldDateAlta.setColumns(10);
...
//			textFieldDateBaja.setColumns(10);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					...
					JOptionPane.showMessageDialog(principal, "Debe seleccionar una Fecha de Alta","Fecha Alta",
				...
				try{
					textFieldDateBaja.getDate();
						...
						JOptionPane.showMessageDialog(principal, "Debe seleccionar una Fecha de Baja","Fecha Baja",
								JOptionPane.WARNING_MESSAGE);
						return;
				}

				int v=JOptionPane.showConfirmDialog(principal, "Esta seguro(a) de Agregar este Periodo?"
						,"Conformacion",JOptionPane.INFORMATION_MESSAGE);
				if(v== JOptionPane.OK_OPTION){
					...
					boolean n=principal.getBaseDeDatos().addFechas(getfechaAlta(), getfechaBaja(), nia, getTipoBeca(), getTipoUsuario(), ""+isAsiduo(),lunesMartes,jueves);
		...
		btnActualizar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				int v=JOptionPane.showConfirmDialog(principal, "Esta seguro(a) de Aplicar la Actualizacion este Periodo?"
						,"Conformacion",JOptionPane.INFORMATION_MESSAGE);
				
				if(v== JOptionPane.OK_OPTION){
					principal.getBaseDeDatos().eliminarPeriodoComedor(id);
					boolean n=principal.getBaseDeDatos().addFechas(getfechaAlta(), getfechaBaja(), nia, getTipoBeca(), getTipoUsuario(), ""+isAsiduo(),"No","No");
					if(n){
						JOptionPane.showMessageDialog(principal, "Procesado Correctamente!","Exito",JOptionPane.INFORMATION_MESSAGE);
						dispose();
					}else
...
//		buttonGroup.add(asi
	...
	public void setAsiduo(Boolean b){
