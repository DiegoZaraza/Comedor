	...
	public InformeYReportes(final ComedorGUI comedorGUI)
	{
		...
		groupLayout
				.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup().addContainerGap()
								.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(panel_2, GroupLayout.PREFERRED_SIZE, 976, GroupLayout.PREFERRED_SIZE)
										.addGroup(groupLayout.createSequentialGroup().addComponent(lblNewLabel).addPreferredGap(ComponentPlacement.RELATED).addComponent(panel, GroupLayout.DEFAULT_SIZE, 727, Short.MAX_VALUE)))
								.addContainerGap()));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(panel, GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE).addComponent(lblNewLabel, GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE))
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 54, Short.MAX_VALUE).addContainerGap()));
				...
				if (jkTable.getSelectedRow() != -1)
				{
					new Thread(new Runnable()
					{
						...
						public void run()
						{
							...
							String selected = JOptionPane.showInputDialog(principal, "Seleccionar", "Seleccionar", JOptionPane.QUESTION_MESSAGE, null, bigList, "Titan").toString();
							if (selected != null)
							{
		...
		btnListadoDeUsuarios.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				final String selected = JOptionPane.showInputDialog(principal, "Seleccionar", "Seleccionar", JOptionPane.QUESTION_MESSAGE, null, bigList, "Titan").toString();
					...
					if (selected.equalsIgnoreCase("Usuarios Comedor"))
					{
						new Thread(new Runnable()
						{
							...
							public void run()
							{
								...
								String selected1 = JOptionPane.showInputDialog(principal, "Seleccionar", "Seleccionar", JOptionPane.QUESTION_MESSAGE, null, bigList1, "Titan").toString();
		...
		btnBalancesEconmicosMensuales.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				String bigList[] = { "01-ENERO", "02-FEBRERO", "03-MARZO", "04-ABRIL", "05-MAYO", "06-JUNIO", "07-JULIO", "08-AGOSTO", "09-SEPTIEMBRE", "10-OCTUBRE", "11-NOVIEMBRE", "12-DICIEMBRE" };
				final String selected = JOptionPane.showInputDialog(principal, "Seleccionar", "Seleccionar", JOptionPane.QUESTION_MESSAGE, null, bigList, "Titan").toString();
				
				String bigList1[] = { "Alumnos", "Profesores" };
				final String selected1 = JOptionPane.showInputDialog(principal, "Seleccionar", "Seleccionar", JOptionPane.QUESTION_MESSAGE, null, bigList1, "Titan").toString();
		...
		btnListadoDePendientes.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				String bigList[] = { "01-ENERO", "02-FEBRERO", "03-MARZO", "04-ABRIL", "05-MAYO", "06-JUNIO", "07-JULIO", "08-AGOSTO", "09-SEPTIEMBRE", "10-OCTUBRE", "11-NOVIEMBRE", "12-DICIEMBRE" };
				final String selectedMes = JOptionPane.showInputDialog(principal, "Seleccionar", "Seleccionar", JOptionPane.QUESTION_MESSAGE, null, bigList, "Titan").toString();
		...
		btnFormatoSalir.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0)
			{
				...
				if (selectedMes != null)
				{
					try
					{
						new PDF_Formato_Salir(principal, selectedMes.split("-")[1], selectedMes.split("-")[0], principal.getBaseDeDatos().getNoUsuariosComedor2(principal.getBaseDeDatos().getCursoActual(), selectedMes.split("-")[0]));
					}
					catch (FileNotFoundException e)
					{
						// TODO Auto-generated catch block
		...
		gl_panel_1
				.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createSequentialGroup().addGap(5).addGroup(
								gl_panel_1.createParallelGroup(Alignment.LEADING).addComponent(panel_4, GroupLayout.DEFAULT_SIZE, 673, Short.MAX_VALUE).addGroup(gl_panel_1.createSequentialGroup()
										.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING, false).addComponent(btnListadoDeUsuarios, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										...
										.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
												.addGroup(gl_panel_1.createSequentialGroup()
														.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING, false).addComponent(btnImprimirInformeTutor, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
																.addComponent(btnNewButton_1, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
														.addGap(2)
														.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING, false).addComponent(btnImprimirOrlaGeneral, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																.addComponent(btnImprimirOrlasProfesores, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
														.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnFormatoSalir, GroupLayout.PREFERRED_SIZE, 143, GroupLayout.PREFERRED_SIZE))
												.addGroup(gl_panel_1.createSequentialGroup().addComponent(btnBalancesEconmicosMensuales, GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE).addPreferredGap(ComponentPlacement.UNRELATED)
														.addComponent(btnListadoDePendientes, GroupLayout.PREFERRED_SIZE, 246, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED)))
										.addGap(40)))));
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_1.createSequentialGroup().addGap(5)
				.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(btnNewButton).addComponent(btnNewButton_1).addComponent(btnImprimirOrlasProfesores)).addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(btnImprimirOrlasPas).addComponent(btnImprimirInformeTutor).addComponent(btnImprimirOrlaGeneral).addComponent(btnFormatoSalir))
				.addPreferredGap(ComponentPlacement.RELATED).addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(btnListadoDeUsuarios).addComponent(btnBalancesEconmicosMensuales).addComponent(btnListadoDePendientes))
				.addPreferredGap(ComponentPlacement.RELATED, 8, Short.MAX_VALUE).addComponent(panel_4, GroupLayout.PREFERRED_SIZE, 179, GroupLayout.PREFERRED_SIZE).addContainerGap()));
		...
		table.addMouseListener(new MouseListener()
		{
			...
			public void mouseReleased(MouseEvent arg0)
			{
				...
				// principal.getBaseDeDatos().getFechasPeriodo(table.getValueAt(table.getSelectedRow(),
				// 1).toString(),tableFechas,listFechas);
			}
		...
		gl_panel_4
				.setHorizontalGroup(gl_panel_4.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_4.createSequentialGroup().addContainerGap()
								.addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_4.createSequentialGroup().addComponent(btnInformeDeAsistencias_1, GroupLayout.PREFERRED_SIZE, 252, GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnInformeDeAsistencias_2, GroupLayout.PREFERRED_SIZE, 234, GroupLayout.PREFERRED_SIZE)).addGroup(gl_panel_4
												.createSequentialGroup()
												.addGroup(gl_panel_4.createParallelGroup(Alignment.TRAILING, false).addComponent(btnInformeDeAsistencias, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addComponent(btnInformeDeFaltas, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGroup(gl_panel_4.createSequentialGroup()
																.addGroup(gl_panel_4.createParallelGroup(Alignment.TRAILING).addComponent(lblFechaInicio).addComponent(lblFechaFin, GroupLayout.PREFERRED_SIZE, 61, GroupLayout.PREFERRED_SIZE))
																.addPreferredGap(ComponentPlacement.RELATED)
																.addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING, false).addComponent(textFieldX2, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																		.addComponent(textFieldX1, GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE))))
												.addPreferredGap(ComponentPlacement.RELATED)
												.addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING).addComponent(comboBox, 0, 403, Short.MAX_VALUE).addComponent(coreBar, GroupLayout.DEFAULT_SIZE, 403, Short.MAX_VALUE)
														.addGroup(gl_panel_4.createSequentialGroup().addComponent(check1).addPreferredGap(ComponentPlacement.RELATED).addComponent(check2, GroupLayout.PREFERRED_SIZE, 164,
																GroupLayout.PREFERRED_SIZE))
														.addGroup(gl_panel_4.createSequentialGroup().addComponent(checkx1).addGap(18).addComponent(checkx2, GroupLayout.PREFERRED_SIZE, 184, GroupLayout.PREFERRED_SIZE)))))
								.addContainerGap()));
		gl_panel_4
				.setVerticalGroup(gl_panel_4.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_4.createSequentialGroup().addContainerGap().addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_4.createSequentialGroup().addGroup(gl_panel_4.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_4.createSequentialGroup()
										.addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(lblFechaInicio).addComponent(textFieldX1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(lblFechaFin).addComponent(textFieldX2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
										.addGroup(gl_panel_4.createSequentialGroup().addGap(25).addComponent(comboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
										.addPreferredGap(ComponentPlacement.RELATED).addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(btnInformeDeFaltas).addComponent(check1).addComponent(check2))
										.addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(btnInformeDeAsistencias).addComponent(coreBar, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)))
								.addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(checkx1).addComponent(checkx2))).addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE).addComponent(btnInformeDeAsistencias_1).addComponent(btnInformeDeAsistencias_2)).addContainerGap()));
